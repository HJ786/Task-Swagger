...
public Collection< Task > getPeople(  @ApiParam( value = "Page to fetch", required = true ) @QueryParam( "page") @DefaultValue( "1" ) final int page ) {
	return taskresource.getPeople( page, 5 );
}
...
public Task getPeople( @ApiParam( value = "ID address to lookup for", required = true ) @PathParam( "id" ) final String id ) {
